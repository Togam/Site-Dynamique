...
<html>
	...
	<body>
		...
		if(isset($_SESSION['status']))
		{
			...
			?>
			<a href="supprimer_livraison.php">Supprimer une livraison</a><br/>
			<a href="supprimer_production.php">Supprimer une Production</a><br>
			<a href="supprimer_verger.php">Supprimer un verger</a>
			<?php
