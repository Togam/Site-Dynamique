...
<html>
	...
	<body>
		...
		if(isset($_SESSION['status']))
		{
			...
			?>
			<a href="ajout_livraison.php">Ajouter une livraison</a><br/>
			<a href="ajout_production.php">Ajouter une Production</a><br>
			<a href="associer_verger.php">Associer un verger</a>
			<?php
